    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-10">
                <h1>Books</h1>
                <hr><br><br>
                <b-alert show dismissible v-if=showMessage>
                    <br>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    <button type="button" class="btn btn-warning btn-sm"
                                        v-b-modal.book-update-modal>Update</button>
        ...
        <b-modal ref="editBookModal" id="book-update-modal" title="Update" hide-footer>
            <b-form @submit="onSubmitUpdate" @reset="onResetUpdate" class="w-100">
                ...
                <b-button-group>
                    <b-button type="submit" class="btn btn-primary btn-sm" @click="editBook(book)">
                        Update
                    </b-button>
        ...
        addBook(payload) {
            ...
            axios.post(path, payload)
                ...
                .catch((error) => {
                    ...
                    console.log(error);
                    this.getBooks();
                    this.message = "Error: Unable to get the data from Server";
                });
        },
        editBook(book) {
            this.editForm = book;
